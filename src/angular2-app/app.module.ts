...
import { DseCoeLaunchComponent } from './dse/dse-coe-launch.component';

@NgModule({
  imports: [ BrowserModule, HttpClientModule, FormsModule,
     MmModule, COEModule, ReactiveFormsModule, SharedModule], // module dependencies
  declarations: [AppComponent , DsePageComponent, DseConfigurationComponent, DseCoeLaunchComponent], // components and directives
