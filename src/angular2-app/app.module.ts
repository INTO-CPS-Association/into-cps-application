...
import { DtpPageComponent} from './dtp/dtp-page.component';

@NgModule({
  imports: [ BrowserModule, HttpClientModule, FormsModule,
     MmModule, COEModule, ReactiveFormsModule, SharedModule], // module dependencies
  declarations: [AppComponent , SafePipe,  DsePageComponent, DseConfigurationComponent, DseCoeLaunchComponent, DtpPageComponent], // components and directives
