...
export {Fmu,ScalarVariable,ScalarVariableType,CausalityType,Instance,InstanceScalarPair,isTypeCompatiple,isCausalityCompatible} from "../angular2-app/coe/models/Fmu";
