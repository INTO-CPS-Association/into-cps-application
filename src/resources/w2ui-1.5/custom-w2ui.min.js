// MANUALY EDITS ARE MARKED WITH: // TODO INTO-CPS APP <INITIALS>: e.g. // TODO INTO-CPS APP CTHA:
                    ...
                    if (txt != null && txt !== '' && !(/^-+$/.test(txt))) {
                        ...
                        menu_html +=
                            ...
                            '               jQuery.fn.w2menuClick(event, \''+ f +'\');">'+
                                imgd +
                            '   <td id="td'+f+'" class="menu-text" colspan="'+ colspan +'">'+ txt +'</td>'+
                            '   <td class="menu-count">'+
...
(function ($) {
    ...
    w2sidebar.prototype = {
        ...
        click: function (id, event) {
            ...
            // TODO INTO-CPS APP CTHA: Manually commented select part.
            // See: https://github.com/vitmalina/w2ui/issues/1267
        ...
        contextMenu: function (id, event) {
            ...
            if (edata.isCancelled === true) return;
            // default action
            // TODO INTO-CPS APP CTHA: Used to be: if (nd.group || nd.disabled) return;
            // See https://github.com/vitmalina/w2ui/issues/1232
